export const Quest = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <g>
        <path
          d="M51.775,54.264C31.718,54.264,15.4,71.193,15.4,92c0,0.828,0.671,1.5,1.5,1.5h69.75c0.828,0,1.5-0.672,1.5-1.5
        ...
        />
        <path
          d="M51.146,50.142c11.568,0,20.98-9.74,20.98-21.713S62.715,6.716,51.146,6.716s-20.979,9.74-20.979,21.713
