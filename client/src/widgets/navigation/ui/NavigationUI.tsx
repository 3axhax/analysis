  ...
  return (
    <header className="header bg-cyan-600 shadow-lg dark:bg-gray-950/95 dark:shadow-white/20">
      ...
      >
        ...
        <ul
          className={`bg-cyan-600 py-4 lg:py-0 flex flex-col lg:justify-start lg:flex-row lg:inline-flex z-40 lg:bg-transparent dark:bg-gray-950 fixed inset-y-0 right-0 w-80 transition-transform duration-300 transform lg:relative lg:right-auto lg:translate-x-0 lg:w-auto lg:px-0 ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"}`}
        >
          {navItems.map((item) => (
              ...
              {item.isDropdown ? (
                <>
                  ...
                  >
                    <span
                      className={
                        "hover:cursor-pointer w-full transition-colors duration-200 group text-orange-50 hover:text-orange-300 hover:border-orange-300 py-2 lg:py-6 px-3 flex items-center bg-cyan-600 lg:w-50 z-2"
                      }
                    >
