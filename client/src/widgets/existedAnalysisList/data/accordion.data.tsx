...
export const accordionItems: AccordionItemType[] = [
    {
        id: 1,
        icon: <CheckCircleIcon className={'inline size-5 text-cyan-600 mr-2 dark:text-white'}/>,
    ...
    },
    {
        ...
        content:  <ul>
            <li>Холестерин и его фракции: ЛПВП, ЛПНП, Триглицериды. Вычисляем коэффициент атерогенности.</li>
        </ul>
    },
    {
        id: 8,
        ...
        content: <ul>
            <li>Общий белок</li>
            <li>Белковые фракции: Альбуминовая, Альфа-1 глобулины, Альфа-2 глобулины, Бета глобулины, Бета-2 глобулины, Гамма глобулины</li>
        </ul>
    },
    {
        id: 9,
